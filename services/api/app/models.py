...
# NOTA: estos modelos mapean tablas que ya existen en Postgres (creadas vía
# schema_control.sql). Esta API nunca corre create_all() sobre ellas: el DDL
# es la fuente de verdad del esquema, no el ORM.
